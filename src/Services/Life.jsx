...
const TwoWheeler = () => {
  ...
  const faqs = [
    {
      ...
      answer:
        "It is a contract between you and the insurer, ensuring your nominee gets financial benefits in case of your untimely death.",
    },
    {
      question: "What are the types of life insurance?",
      answer:
        "Term plans, whole life, ULIPs, endowment, money-back, child, and pension plans.",
    },
    {
      question: "Why should I buy life insurance?",
      answer:
        "It secures your family’s financial stability, covers debts, and offers tax benefits.",
    },
    {
      question: "What are the tax benefits?",
      answer:
        "Premiums qualify for Section 80C deductions, and payouts are tax-free under Section 10(10D).",
    },
    {
      question:
        "How can nominees claim after death?",
      answer:
        "By submitting a claim form, death certificate, and required documents to the insurer.",
    },
    {
      question: "Can a claim be denied?",
      answer:
        "Yes, due to non-disclosure of facts, fraud, or exclusions mentioned in the policy.",
    },
    {
  ...
  return (
    <>
      <Helmet>
        <title>
          Life Insurance - Secure Your Future with the Best Plans Online
        </title>
        <meta
          name="description"
        ...
        >
          ...
          <div className="col-12 col-md-6 text-left">
            ...
            <img
              src={checklistIcon}
              alt="Checklist Icon"
              className="img-fluid checklist-icon d-none d-lg-none"
            />
          </div>
                      ...
                      {currentStep === 1 && (
                        <div style={{ textAlign: "center" }}>
                          <p style={{ fontWeight: "600" }}>
                            Buy Life insurance, the smart way,
                          </p>
                          ...
                          >
                            ...
                            >
                              <input
                                ...
                                checked={
                                  policyOption === "InvestmentandTaxPlanning"
                                }
                                onChange={(e) =>
                                  setPolicyOption(e.target.value)
                                }
   ...
   <br /><br />
        ...
        >
          ...
          <p style={{ textAlign: "left" }}>
            ...
            more than just a financial product—it is a promise to safeguard your
            loved ones when you’re no longer around. It ensures that your
            family’s financial needs, from daily living expenses to long-term
            goals, are met even in your absence.
          </p>
          <p style={{ textAlign: "left" }}>
            At Make My Documents, we make applying for life insurance quick,
            simple, and stress-free. Whether you’re looking for term plans,
            savings-linked policies, or investment-oriented life insurance, we
            guide you through the process so you can choose the best option for
            your needs.
          </p>
          ...
          >
            <li>
              <strong>Financial Security for Loved Ones: </strong> Provides a
              lump sum or regular income to your family after your death.
            </li>
            <li>
              <strong> Debt Protection: </strong> Ensures that loans such as
              home loans or personal loans don’t become a burden on your family.
            </li>
            <li>
              <strong> Wealth Creation: </strong> Some plans offer maturity
              benefits, helping you build a financial cushion for future goals.
            </li>
            <li>
              <strong>Peace of Mind: </strong> Live life with the assurance that
              your family will be protected financially.
            </li>
            <li>
              <strong>Tax Benefits: </strong> Premiums qualify for deductions
          ...
          >
            ...
            <li>
              {" "}
              Income Proof (Salary slip, ITR, or bank statement for certain
              policies)
            </li>
            <li>
              Medical Reports (if required by the insurer for higher coverage){" "}
            </li>
          </ul>
          <p style={{ textAlign: "left" }}>
            Our experts at Make My Document ensure you have everything in place
          ...
          <p style={{ textAlign: "left" }}>
            We simplify the life insurance process into easy steps:
          </p>
          <ul
            style={{
              textAlign: "left",
          ...
          >
            <li>
              <strong>Register Online – </strong>Share your basic details on our
              website.{" "}
            </li>
            <li>
              <strong>Get Quotation via Email/WhatsApp –</strong> Instantly
              receive policy options tailored to you.
            </li>
            <li>
              <strong>Talk to Experts – </strong> Our advisors explain features,
              benefits, and help you choose the right plan.
            </li>
            <li>
              <strong>Compare Policies – </strong> Check premiums, coverage, and
              benefits side by side.
            </li>
            <li>
              <strong>Make Payment – </strong> Pay securely online through our
              trusted platform.
            </li>
            <li>
              <strong>Download Your Policy Instantly –</strong> Get your
              e-policy within minutes, ready for future use.
            </li>
          </ul>
          ...
          >
            <li>
              <strong>Term Life Insurance – </strong> Pure protection plan that
              offers high coverage at affordable premiums.
            </li>
            <li>
              <strong>Whole Life Insurance – </strong> Provides lifelong
              coverage, often with savings benefits.
            </li>
            <li>
              <strong>Endowment Plans – </strong> Combines insurance with
              savings, offering maturity benefits.
            </li>
            <li>
              <strong>ULIPs (Unit Linked Insurance Plans) – </strong> Offers
              insurance along with investment opportunities in equity and debt
              funds.
            </li>
            <li>
              <strong>Money-Back Plans – </strong> Periodic payouts during the
              policy term plus life cover.
            </li>
            <li>
              <strong>Child Plans – </strong> Helps secure your child’s
              education and future goals.
            </li>
            <li>
              <strong>Retirement/Pension Plans – </strong> Ensures a regular
              income post-retirement while providing life cover.
            </li>
          </ul>
          ...
          >
            <li>
              Premiums paid are eligible for deduction under Section 80C (up to
              ₹1.5 lakh annually).
            </li>
            <li>
              Payouts received on maturity or death are tax-free under Section
              10(10D), subject to certain conditions.
            </li>
            <li>
              Retirement and pension plans also offer tax deductions under
              Section 80CCC.
            </li>
          </ul>
          <p style={{ textAlign: "left" }}>
            Thus, life insurance doubles up as both a protection and tax-saving
            tool.
          </p>
