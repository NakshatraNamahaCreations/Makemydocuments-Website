...
import bannerimage from "../../images/passportnewbanner.png";
...
const TravelVisaNew = () => {
  ...
  const handleScroll = () => {
    ...
    const stickyOffset = 100; // adjust as needed

    if (scrollTop > firstColumnTop - bannerHeight - stickyOffset) {
      setIsSticky(true);
    } else {
      setIsSticky(false);
    }
          ...
          <div style={{ margin: 0, fontFamily: "Poppins, sans-serif" }}>
            ...
            <div className="container my-5">
              <div className="row" style={{ position: "relative" }}>
                ...
                <div
  ref={firstColumnRef}
  className={`col-md-8 ${isSticky ? "sticky-class" : ""}`}
>
...
<p  style={{textAlign:'left'}}>
        Are you thinking about traveling abroad. To free you up to devote more time to organizing your trip, we handle all the formalities of your tourist visa in a fast and simple way, making the whole process less stressful.  
          ...
          <h2 className="faq-tag-title-h3" style={{textAlign:'left', fontSize: "22px"}}>
            <strong>Get the Best Tourist Visa Assistance </strong>
          </h2>
          <p  style={{textAlign:'left'}}>
   ...
   <h2 className="faq-tag-title-h3" style={{textAlign:'left', fontSize: "22px"}}>
       ...
       <h2 className="faq-tag-title-h3" style={{textAlign:'left', fontSize: "22px"}}>
          ...
          <p  style={{textAlign:'left'}}>
          As your tourist visa agents, we do more than just process paperwork. We provide step-by-step assistance, including:
        ...
        Our goal is to make us your go-to visa consultants, so you can travel confidently without worrying about delays or rejections.
          </p> 
          <h2 className="faq-tag-title-h3" style={{textAlign:'left', fontSize: "22px"}}>
