...
const FourWheeler = () => {
  ...
  const faqs = [
    {
      question: "What documents are mandatory for protecting my four-wheeler?",
      answer:
        "You need to maintain a valid Registration Certificate (RC), Insurance Papers, PUC Certificate, Driving License, and ID proof. Additional documents like loan/lease agreements or NOC may be required depending on your vehicle status.",
    },
    {
      question:
        "Can I apply for four-wheeler insurance  online through Make My Document?",
      answer:
        "Yes, with Make My Document, the entire process is 100% online. You can register, upload your documents, make payment, and receive verified documents via email or WhatsApp without visiting any office.",
    },
    {
      question:
        "How does Make My Documents ensure the safety of my car documents?",
      answer:
        "We use secure digital channels for document uploads and strictly protect customer data. Your personal and vehicle-related information remains confidential and is handled only by authorized experts.",
    },
    {
      question:
        "How long does it take to get my four-wheeler insurance  processed?",
      answer:
        "The typical processing time is 01 working days, depending on the type of service. For urgent cases, our team ensures priority handling to avoid delays.",
    },
    {
    ...
    },
    {
      ...
      answer: (
        <div>
          <p>
            The Insured Declared Value (IDV) represents the actual sum insured
            of the car insurance policy. It is calculated by deducting the
            age-based depreciation from the market value of the car. The
            applicable depreciation rates depend on the age of the car, as shown
            in the table below:
          </p>
          <table
            border="1"
          ...
          <p>
            If the car is more than 5 years old, the IDV is mutually decided
            between the insurance company and the policyholder. The IDV is paid
            as a claim if the car is damaged beyond repair or if it is stolen.
          </p>
        </div>
      ),
    },
  ...
  return (
    <>
      <Helmet>
        <title>
          {" "}
          Car Insurance Online - Buy/Renew Car Insurance Policy Online{" "}
        </title>
        <meta
          name="description"
          content=" Click here to get car insurance instantly, comprehensive or thrid party liability, no paper work, and instant policy download, complete online process."
        />
        <meta
          name="keywords"
          content=" car insurance India, car insurance, car insurance near me, car insurance online, car insurance agent in Bangalore, Compare car insurance online, car insurance policy, Third party car insurance online, best car insurance India, how to get car insurance online, apply car insurance, get car insurance online, instant car insurance, car insurance Bangalore, car insurance price, car insurance renewal, car insurance renewal policy"
        />
        <meta
          name="author"
        ...
        >
          ...
          <div className=" d-none d-lg-block">
            ...
            <div className="desktop-how mb-5">
              ...
              <ul
                className="text-ul"
                style={{ listStyleType: "disc", whiteSpace: "nowrap" }}
              >
                <li style={{ padding: "0px", marginBottom: "0px" }}>
                  Register Online
                </li>
                      ...
                      {currentStep === 1 && (
                        <div style={{ textAlign: "center" }}>
                          <p style={{ fontWeight: "600" }}>
                            Buy / Renew Car insurance without inspection or
                            paperwork
                          </p>
   ...
   <div
      ...
      >
        ...
        <p style={{ textAlign: "left" }}>
          ...
          and stress-free. From securing the right documents to ensuring
          compliance with regulations, our experts help you safeguard your
          vehicle with ease.
        </p>
        ...
        >
          <li>Stay legally compliant on the road</li>
          <li>Get insurance support for accidental damage or theft</li>
          <li>Avoid penalties and fines for missing documents</li>
...
<h5 style={{ textAlign: "left" }}>
        ...
        >
          ...
          <li>Loan / Lease Agreement (if applicable)</li>
           <li>Driving License and ID Proof</li>
        </ul>
...
<h5 style={{ textAlign: "left" }}>
        ...
        >
          <li><strong>Register Online: </strong>Fill in your basic details in just a few clicks</li>
           <li><strong>Upload Documents: </strong>Securely share your car papers for verification</li>
            <li><strong>Expert Support: </strong>Our team ensures accuracy and compliance</li>
             <li><strong>Get Delivered: </strong>Receive your processed documents online or at your doorstep</li>
        </ul>
        ...
        >
          <li>Trusted brand for fast and reliable documentation services</li>
          <li>100% online convenience – no need to visit offices</li>
        ...
        <p style={{ textAlign: "left" }}>
          ...
          four-wheeler is safe, secure, and compliant.
        </p>
      </div>
